...
class MapsContainer extends Component {
  ...
  handleSearch = (() => {
    ...
    const placesRequest = {
      ...
      type: ['bar', 'night_club'], // List of types: https://developers.google.com/places/supported_types
      query: ['bar', 'drinks'],
    ...
    placesService.textSearch(placesRequest, ((response) => {
      ...
      for (let i = 0; i < responseLimit; i++) {
        ...
        const address = bar.formatted_address; // e.g 80 mandai Lake Rd,
        const priceLevel = bar.price_level; // 1, 2, 3...
        let photoUrl = '';
        let openNow = false;
  ...
  render() {
    ...
    return (
      <div className="w-100 d-flex py-4 flex-wrap justify-content-center">
        <h1 className="w-100 fw-md">Find Some Bars!</h1>
        {/* Constraints section */}
